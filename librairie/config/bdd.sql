...
CREATE DATABASE IF NOT EXISTS `grds`
CHARACTER SET UTF8 COLLATE UTF8_GENERAL_CI /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `grds`;

-- Listage de la structure de la table grds. admin
...
-- Listage des données de la table grds.admin : ~0 rows (environ)
DELETE FROM `admin`;
...
-- Listage de la structure de la table grds. affiliate
...
-- Listage des données de la table grds.affiliate : ~0 rows (environ)
...
-- Listage des données de la table grds.classe : ~2 rows (environ)
DELETE FROM `classe`;
...
-- Listage de la structure de la table grds. currentinternship
...
-- Listage des données de la table grds.currentinternship : ~0 rows (environ)
...
-- Listage des données de la table grds.interest : ~2 rows (environ)
...
-- Listage des données de la table grds.student : ~2 rows (environ)
DELETE FROM `student`;
...
-- Listage de la structure de la table grds. teacher
...
-- Listage des données de la table grds.teacher : ~0 rows (environ)
DELETE FROM `teacher`;
